...
class Scale:
    def __init__(self):
        ...
        try:
            ...
            if self.mode == "MOCK":
                print("[Scale] MOCK modda başlatıldı - Simülasyon aktif")
            else:
            ...
            # Sürekli okuma thread'i başlat (MOCK modda da çalışsın)
            self.running = True
    ...
    def tare(self):
        ...
        try:
            ...
            if self.mode != "MOCK":
                ...
                self.hx.tare(TARE_SAMPLES)  # Mock HX711 de tare yapabilir
